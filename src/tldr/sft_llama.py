...
class Args:
    # common args
    exp_name: str = "llama_SFT"
    """the name of this experiment"""
    seed: int = 555134
    """seed of the experiment"""
    track: bool = True
    """if toggled, this experiment will be tracked with Weights and Biases"""
    wandb_project_name: str = "tldr_summarize_llama"
    ...
    output_dir: str = "models/sft_tldr_llama_3.1_8b_lora"
...
if __name__ == "__main__":
    ...
    model_config = AutoConfig.from_pretrained(args.base_model, attn_implementation="eager")
